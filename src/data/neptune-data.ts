...
export const NEPTUNE_DATA: NeptuneCMS = {
  ...
  about: {
    ...
    mission: "Make technology simpler, faster, and genuinely more valuable for businesses of every scale.",
    vision: "Build technology that creates measurable business impact — not unnecessary complexity.",
